...
export const metadata: Metadata = {
  ...
  description: 'kpsscografya.com.tr platformunun vizyonu, misyonu ve hazırlık süreci hakkında bilgi alın.',
};
        ...
        <div className="bg-white rounded-[40px] shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-8 md:p-16 prose prose-gray max-w-none">
            ...
            <p className="text-gray-600 leading-relaxed text-lg mb-8">
              ...
              <strong> görerek ve keşfederek</strong> öğrenmeleri için geliştirilmiş bağımsız bir eğitim projesidir. 
              Geleneksel konu anlatımlarının ötesine geçerek, her veriyi Türkiye haritası üzerinde canlandırıyoruz.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
              <div className="bg-blue-50 p-8 rounded-3xl border border-blue-100">
                ...
                <p className="text-blue-800/70 text-sm leading-relaxed">
                  Coğrafya eğitiminde dijitalleşmeyi en üst seviyeye taşıyarak, her adayın Türkiye&apos;nin kaynaklarını, 
                  yer şekillerini ve ekonomik potansiyelini avucunun içi gibi bilmesini sağlamak.
                </p>
              </div>
            ...
            <ul className="space-y-4 text-gray-600 list-none p-0">
              <li className="flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                ...
                <div>
                  ...
                  Madenlerin, tarım ürünlerinin ve sanayi tesislerinin dağılımını 81 il bazında harita üzerinde görün.
                </div>
              </li>
              <li className="flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                ...
                <div>
                  ...
                  Her il için özel olarak hazırlanmış, sınavda çıkma ihtimali yüksek kritik noktalar.
                </div>
              </li>
              <li className="flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <span className="text-xl">✍️</span>
                <div>
                  ...
                  Konuları öğrendikten sonra hemen kendinizi test edebileceğiniz yapay zeka destekli soru bankası.
                </div>
              </li>
            </ul>
            ...
            <div className="mt-16 p-8 bg-gray-900 rounded-[32px] text-center text-white">
              ...
              <p className="text-gray-400 mb-8">Hemen bir konu seç ve Türkiye&apos;yi keşfetmeye başla.</p>
              <Link href="/konu" className="inline-block bg-harita-mavi hover:bg-harita-mavi-dark text-white font-black py-4 px-10 rounded-2xl transition-all transform hover:scale-105">
                Konulara Göz At →
              </Link>
            </div>
          </div>
