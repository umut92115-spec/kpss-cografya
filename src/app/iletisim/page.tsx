...
export const metadata: Metadata = {
  ...
  description: 'kpsscografya.com.tr platformu ile iletişime geçin. Soru, görüş ve önerilerinizi bize iletin.',
};
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            <h1 className="text-4xl font-black text-gray-900 leading-tight">Bizimle İletişime Geçin</h1>
            <p className="text-gray-500 leading-relaxed">
              Platformumuz hakkında her türlü soru, öneri veya hata bildirimi için bize ulaşabilirsiniz.
            </p>
