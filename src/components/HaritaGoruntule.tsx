                    ...
                    <div className="p-2 min-w-[200px]">
                      ...
                      <div className="space-y-1 text-sm border-t pt-2 mt-2">
                        <p>
                          ...
                          <span className="font-medium">{dag.tur}</span>
                        </p>
                        {dag.yukseklik && (
                          <p>
                            <span className="text-gray-500">Yükseklik:</span>{" "}
                            <span className="font-medium text-blue-600">{dag.yukseklik} m</span>
                          </p>
                        )}
                        {dag.ozellik && (
                          <p className="text-xs text-gray-600 italic bg-gray-50 p-2 rounded mt-2">
                            &quot;{dag.ozellik}&quot;
                          </p>
                        )}
                      </div>
                      ...
                      <div className="p-2">
                        ...
                        <div className="text-sm space-y-1 border-t pt-2 mt-2">
                          <p>
                            ...
                            <span className="font-medium">{gol.su_turu}</span>
                          </p>
                          <p>
                            <span className="text-gray-500">Oluşum:</span>{" "}
                            <span className="font-medium">{gol.olusum}</span>
                          </p>
                          {gol.kpss_notu && (
                            <div className="mt-3 bg-blue-50 text-blue-800 p-2 rounded-lg text-xs font-semibold border border-blue-100 italic">
                              📌 {gol.kpss_notu}
                            </div>
                          )}
                        </div>
          ...
          >
            <LayerGroup>
              {tumKapilar.map((kapi, i) => (
                <Marker key={`kapi-${i}`} position={[kapi.lat, kapi.lng]} icon={icons.gate}>
                  <Tooltip offset={[0, -12]}>
                    <b>{kapi.ad}</b>
                  </Tooltip>
                  <Popup>
                    <div className="p-2">
                      ...
                      {kapi.ozellik && (
                        <p className="text-xs mt-2 text-gray-600 bg-red-50 p-2 rounded">
                          {kapi.ozellik}
                        </p>
                      )}
                    </div>
                ...
                <Marker key={`ak-${i}`} position={[ak.lat, ak.lng]} icon={icons.river}>
                  <Popup>
                    <div className="p-2">
                      ...
                      <p className="text-sm">
                        <b>Havza:</b> {ak.havza.toUpperCase()}
                      </p>
