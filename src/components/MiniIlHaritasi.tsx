...
export default function MiniIlHaritasi({ secilenIlSlug, bolgeIlleri, ilAdi, bolgeAdi }: MiniIlHaritasiProps) {
  ...
  const slugify = (text: string) => {
    const trMap: Record<string, string> = { 'ç': 'c', 'ğ': 'g', 'ş': 's', 'ü': 'u', 'ı': 'i', 'ö': 'o', 'Ç': 'C', 'Ğ': 'G', 'Ş': 'S', 'Ü': 'U', 'İ': 'I', 'Ö': 'O' };
    let str = text.trim();
