    ...
    faqlar: [
      {
        ...
        cevap:
          "TYT sınavında Sosyal Bilimler testi içerisinde 5 adet coğrafya sorusu yer almaktadır.",
      },
      {
        soru: "TYT coğrafya için harita bilgisi ne kadar önemli?",
        cevap:
          "Çok önemli. Soruların neredeyse tamamı harita okuma veya dünya üzerindeki yerleri tanıma becerisi gerektirir.",
      },
      {
        soru: "TYT coğrafya konuları zor mu?",
        cevap:
          "Daha çok temel kavramlar ve yorumlama üzerine kuruludur. Mantığını kavradığınızda 5'te 5 yapmak oldukça kolaydır.",
      },
    ],
    makale: `
    ...
    faqlar: [
      {
        ...
        cevap:
          "AYT'de Sosyal-1 testinde 6, Sosyal-2 testinde 11 soru olmak üzere toplam 17 coğrafya sorusu vardır.",
      },
      {
        soru: "AYT coğrafya KPSS ile benzer mi?",
        cevap:
          "Özellikle Türkiye Ekonomisi ve Beşeri Coğrafya kısımları KPSS ile %90 oranında benzerlik gösterir.",
      },
    ],
    makale: `
