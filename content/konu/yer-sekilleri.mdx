...
<SmartFAQ 
  items={[
    { 
      q: "Karacadağ neden diğer volkanlardan farklıdır?", 
      a: "Diyarbakır'daki Karacadağ, lavları çok akışkan olduğu için kalkan biçimli bir volkandır (Yüksekliği az, alanı geniştir)." 
    },
    { 
      q: "Menderes nedir?", 
      a: "Akarsuyun eğimin azaldığı yerlerde çizdiği büklümlerdir. Ege bölgesinde yaygındır. Hem aşınım hem birikim şeklidir." 
    },
    { 
      q: "Falez nerede yaygındır?", 
      a: "Dağların denize paralel ve yakın olduğu Doğu Karadeniz ve Antalya-Taşeli kıyılarında yaygındır." 
    }
  ]}
/>
